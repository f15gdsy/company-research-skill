...
> 简要说明当前主力技术、下一代技术方向及公司准备情况、可能在哪个技术岔路口掉队。
> 例如：当前 800G 可插拔（已量产）→ 1.6T（放量中）→ CPO（2028E，专利储备为龙头 1/3，存在掉队风险）
...
**快速模式下仍须遵守的核心纪律（不可省略）：**
> - 营收/净利润两个关键数字必须双源交叉验证，否则标注"暂缺"
> - 禁止使用"独家""唯一""绝对"等未经验证的绝对化表述
> - 至少标注每个数字的数据口径（公司披露/券商估算）
